    ...
    <div className="min-h-dvh bg-[var(--bg)] text-[var(--text)]">
      ...
      <aside aria-label="サイドバーナビゲーション" className="hidden bg-[var(--surface)] lg:fixed lg:inset-y-0 lg:left-0 lg:flex lg:w-[236px] lg:flex-col lg:border-r lg:border-[var(--border)]">
        ...
        <div className="border-t border-[var(--border)] px-3 py-4 space-y-2">
          ...
          <form action={signOut} className="w-full" data-cross-area-nav>
            <LogoutButton />
          </form>
        </div>
      </aside>
            ...
            <div className="hidden lg:flex lg:flex-1 lg:items-center lg:gap-4 lg:min-w-0">
              ...
              <div className="ml-auto flex shrink-0 items-center gap-3">
                ...
                <Link
                  href="/settings"
                  aria-label="設定"
                  className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full border border-[var(--border)] overflow-hidden bg-[var(--accent-l)] text-[13px] font-semibold text-[var(--on-primary-container)] transition-colors hover:border-[var(--accent)]"
                >
                  {avatarUrl ? (
