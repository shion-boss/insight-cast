...
// /pricing 側の PLANS と同じデータ形に揃える（price は数値、features は文字列配列）
const PAID_PLANS = [
  {
    id: 'lightning',
    name: 'ライト',
            ...
            >
              ...
              {isLoggedIn ? (
                ...
                <Link
                  ...
                  prefetch={false}
                  className="text-center rounded-full px-6 py-3 text-base font-semibold bg-[var(--accent)] text-white hover:bg-[var(--accent-h)] transition-colors"
                >
                  {plan.cta}
                </Link>
              )}
