    ...
    <section className="cv-auto-section py-14 sm:py-[96px] overflow-hidden bg-[var(--surface2)]">
      <div className="mx-auto max-w-[1160px] px-6 sm:px-8 lg:px-12">
        <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1fr)_520px] lg:gap-16">
          <div>
            <div className="text-[12px] font-semibold tracking-[0.14em] text-[var(--accent)] mb-4">ステップ 01 ─ ホームページ調査</div>
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -right-4 bg-[rgba(255,253,249,.96)] backdrop-blur-[6px] border border-[var(--border)] rounded-[14px] px-4 py-3 shadow-[var(--elevation-3)]">
              <div className="text-[12px] font-semibold text-[var(--on-primary-container)] tracking-[.08em] mb-1">競合調査</div>
