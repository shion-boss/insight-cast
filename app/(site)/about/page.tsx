      ...
      <main id="main-content" className="relative z-10">
        ...
        <section className="relative overflow-hidden bg-[var(--bg)]" style={{ minHeight: '420px' }}>
          ...
          >
            <div className="md:w-[55%] md:pr-12">
              <p className="text-xs font-bold tracking-[0.22em] uppercase text-[var(--on-primary-container)] mb-4">About</p>
              <h1
        ...
        <section className="bg-[var(--bg2)]" style={{ padding: 'clamp(64px,7vw,96px) clamp(32px,6vw,80px)' }}>
          <div className="max-w-[800px] mx-auto">
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-[var(--accent)] mb-4">Why We Started</p>
            <h2
        ...
        <section className="relative overflow-hidden" style={{ background: 'var(--text)', padding: 'clamp(64px,8vw,112px) clamp(32px,8vw,120px)' }}>
          ...
          <div
            ...
            style={{ top: '-100px', right: '-100px', width: '500px', height: '500px', borderRadius: '50%', background: 'radial-gradient(circle, color-mix(in srgb, var(--accent) 10%, transparent) 0%, transparent 65%)' }}
          />
          <div className="relative z-10 max-w-[800px] mx-auto">
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-[var(--accent)] opacity-70 mb-4">Mission</p>
            <p
        ...
        <section className="bg-[var(--bg)]" style={{ padding: 'clamp(64px,7vw,96px) clamp(32px,6vw,80px)' }}>
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-[var(--accent)] mb-4">Our Cast</p>
        ...
        <section className="bg-[var(--bg2)]" style={{ padding: 'clamp(64px,7vw,96px) clamp(32px,6vw,80px)' }}>
          <div className="text-center mb-14">
            <p className="text-xs font-bold tracking-[0.22em] uppercase text-[var(--accent)] mb-4">Our Team</p>
            <h2 className="font-[family-name:var(--font-noto-serif-jp)] font-bold text-[var(--text)]" style={{ fontSize: 'clamp(20px,2.2vw,28px)' }}>
        ...
        <section className="px-6 py-14 sm:py-[88px]">
          <div className="mx-auto max-w-3xl text-center">
            <p className="text-[11px] font-semibold tracking-[0.14em] uppercase text-[var(--accent)]">Read more</p>
