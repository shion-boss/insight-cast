...
const FAQ_GROUPS: FaqGroup[] = [
    ...
    items: [
      {
        ...
        a: 'ホームページの更新に困っている中小事業者向けに、AI取材から記事素材化までを提供するサービスです。取材先を登録すると、HP調査・競合比較・キャストによる取材・記事素材の生成へ進められます。',
      },
      {
  ...
  },
  {
    ...
    items: [
      {
        q: '無料プランでできることは？',
        a: '月2回のAI取材・3名のフリーキャスト・基本HP分析レポート・取材メモ生成・記事素材の作成が無料でご利用いただけます。クレジットカードは不要です。',
      },
      {
        q: 'いつでも解約できますか？',
