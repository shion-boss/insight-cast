    ...
    sections: [
      {
        ...
        body: [
          '従来のSEO記事は「検索ワードに答える」ことで評価されてきました。しかしAI検索は、そのような記事を大量に学習したうえで要約して答えを出します。つまり、AIが書けるレベルの記事は、AIが要約して終わりになります。',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          '取材班が使うアプローチは、エピソードから入ることです。「最近、印象に残っているお客様はいますか」「うまくいった仕事を1つ教えてください」——こういう質問には、具体的な話が返ってきます。',
      ...
      },
      {
        ...
        body: [
          '動物キャラクターを取材班にしているのも、この理由からです。スーツのコンサルタントに「御社の差別化ポイントは」と聞かれると、人は身構えます。でも「最近どんなお客さん来てますか？」と話しかけられると、ふだんの言葉で答えられます。',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          '数回更新して止まる理由のひとつに、「もう書くことがない」という感覚があります。しかし取材班の目から見ると、話せることは尽きていません。',
          '仕事の現場は毎日動いています。お客様との会話の中に、サービスの季節性の中に、素材はいくらでも眠っています。問題は「それが記事になる」と気づけないことです。取材班がいれば、その気づきを一緒に拾っていけます。',
        ],
      },
    ],
  },
