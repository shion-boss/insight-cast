...
function buildConversationHtml(opts: {
  ...
  return `<div style="box-sizing:border-box;max-width:800px;width:100%;margin:0 auto;padding:32px;font-family:system-ui,-apple-system,sans-serif;color:#1c1410;">
