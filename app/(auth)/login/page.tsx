  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-stone-50">
      <div className="w-full max-w-sm p-8 bg-white rounded-2xl shadow-sm">
        <h1 className="text-2xl font-semibold text-stone-800 mb-2 text-center">Insight Cast</h1>
        ...
        <button
          ...
          className="w-full py-2 border border-stone-200 rounded-lg text-stone-700 text-sm hover:bg-stone-50 transition-colors flex items-center justify-center gap-2 mb-6"
        >
        ...
        <p className="text-center text-sm text-stone-400 mt-6">
          ...
          <button
            ...
            className="text-stone-600 underline ml-1"
          >
