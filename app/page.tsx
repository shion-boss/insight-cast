...
const PLANS = [
  {
    ...
    period: '',
    desc: 'まず体験してみてください',
    features: ['取材回数：月2回まで', 'フリーキャスト 3名', '取材先登録：1件', '競合調査：1社', '取材メモ・記事素材の生成', '追加キャスト：買い切りで追加可'],
    cta: '無料で始める',
    href: '/auth/signup',
    highlight: false,
  },
  {
    ...
    features: ['取材回数：月10回まで', 'フリーキャスト 3名', '取材先登録：1件', '競合調査：3社', '取材メモ・記事素材の生成', '追加キャスト：買い切りで追加可'],
    cta: '個人向けで始める',
    href: '/auth/signup',
    highlight: true,
  },
