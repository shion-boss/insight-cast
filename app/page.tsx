...
const WORKFLOW_ITEMS = [
  { n: '01', title: 'HPを分析する', body: '取材先を登録すると、AIで現状のホームページと競合サイトを調べられます。何が足りないかを可視化します。' },
  { n: '02', title: 'AIが取材する', body: 'キャストがチャット形式で丁寧に質問。専門知識なしで話すだけで、隠れた価値を引き出します。' },
  { n: '03', title: '記事素材を届ける', body: '取材メモをもとに記事の素材を生成。下書きとして整え、掲載前のたたき台にできます。' },
] as const
...
const PLANS = [
  {
    ...
    period: '',
    desc: 'まず体験してみてください',
    features: ['取材回数：月2回まで', 'フリーキャスト 3名', '取材先登録：1件', '競合調査：1社', '取材メモ・記事素材の生成', '追加キャスト：準備中'],
    cta: '無料で始める',
    href: '/auth/signup',
    highlight: false,
  },
