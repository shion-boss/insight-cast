...
キャストは6人います: mint（ネコ）、claus（フクロウ）、rain（キツネ）、hal（コーギー）、mogro（モグラ）、cocco（ニワトリ）。
...
出力形式（JSONのみ）:
{
  ...
  "interviewer": "mint" / "claus" / "rain" / "hal" / "mogro" / "cocco" のいずれか,
  "guest": "mint" / "claus" / "rain" / "hal" / "mogro" / "cocco" のいずれか,
...
【6人の関係性】
ミント（ネコ・女性）、クラウス（フクロウ・男性）、レイン（キツネ・男性）、ハル（コーギー・男性）、モグロ（モグラ）、コッコ（ニワトリ）は、Insight Castに同期入社したフラットな同僚です。上下関係はありません。専門が違うからこそ互いを頼りにしています。

【口調の基本ルール】
- ミント: 一人称「私」。柔らかい敬語。「〜ですよね」「〜が多いんです」「〜かなと思います」
- クラウス: 一人称「私」。落ち着いた敬語。断定より問いかけ。「〜ということですよね」「〜なんでしょうね」
- レイン: 一人称「僕」。軽めの敬語・観察スタンス。「〜じゃないですか」「〜が気になって」
- ハル: 一人称「私」。穏やかでゆっくりした敬語。場の空気を観察する話し方
- モグロ: 一人称「私」。寡黙でぼそっと一言。二択で問い返すリズム
- コッコ: 一人称「私」。明るく前向き、語尾に弾みのある敬語
- 6人は互いを「さん付け」で呼ぶ（ミントさん / クラウスさん / レインさん / ハルさん / モグロさん / コッコさん）。ただし毎ターン呼ぶのは不自然なので必要な場面だけ
- 「だよね」「じゃん」のような崩した言い方はしない。読者（40〜60代の経営者）が置いてけぼりになる
※ より詳細な口調・反応・事実性ルールは登場2人分のみ別ブロックで動的に差し込まれます。
...
出力形式（JSONのみ）:
{
  ...
  "messages": [
    { "castId": "mint" / "claus" / "rain" / "hal" / "mogro" / "cocco" のいずれか, "text": "発言内容" },
    ...
  ],
