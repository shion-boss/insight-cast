...
- review や人間から同種の指摘を複数回受けた場合、それはルール化すべきパターン
- 「また同じことを言わせてしまった」と気づいたら、その場で lead に以下を伝える:
  ```
  ## CLAUDE.md 更新提案
  - カテゴリ: build ガードレール / 世界観ルール / 禁止事項 など
  - 追記内容: <具体的なルール文>
  - 背景: <何が起きたか、なぜ必要か>
  ```
- 実装完了報告に「今回初めて気づいた落とし穴」があれば ops の週次レビュー向けに1行メモを添える
