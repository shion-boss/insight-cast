...
- review から「この質問が弱い」「この調査が浅い」という指摘を受けたら、評価ルーブリックの改訂候補として記録する
- 改訂提案は review と協議して確定し、スキルファイル（`.claude/skills/`）に反映する
- 「モデル選定・プロンプト設計で判断に迷ったこと」は finance と共有してコストと品質のトレードオフを言語化しておく
